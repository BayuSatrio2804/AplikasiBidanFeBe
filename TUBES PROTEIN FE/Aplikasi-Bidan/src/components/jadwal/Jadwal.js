...
function Jadwal({ onBack, onToRiwayatDataMasuk, onToRiwayatMasukAkun, onToProfil, onToTambahPasien, onToTambahPengunjung, onToBuatLaporan, onToPersalinan, onToANC, onToKB, onToImunisasi }) {
  ...
  const fetchJadwal = async (bulan = '', tahun = '', layanan = '') => {
    try {
      // TODO: Replace with actual API call GET /jadwal
      // const params = new URLSearchParams();
      // if (bulan) params.append('bulan', bulan);
      // if (tahun) params.append('tahun', tahun);
      // if (layanan) params.append('layanan', layanan);
      // const response = await fetch(`https://api.bidan-digital.com/v1/jadwal?${params}`, {
      ...
      const mockData = [
        { 
          ...
          jam_selesai: '10:00',
          jenis_layanan: 'ANC',
          nama_pasien: 'Data Jadwal',
          nama_petugas: 'Bidan A'
        },
        { 
          id_jadwal: '2', 
          tanggal: '2025-01-16',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingJadwal) {
        // Update jadwal - PUT /jadwal/{id}
        // const response = await fetch(`https://api.bidan-digital.com/v1/jadwal/${editingJadwal.id_jadwal}`, {
        //   method: 'PUT',
        //   headers: {
        ...
        // });
        // const data = await response.json();
        console.log('Update jadwal:', formData);
        showNotifikasi({
          type: 'success',
        ...
        // Create jadwal - POST /jadwal
        // const response = await fetch('https://api.bidan-digital.com/v1/jadwal', {
        //   method: 'POST',
        //   headers: {
        //     'Content-Type': 'application/json',
        //     'Authorization': `Bearer ${localStorage.getItem('token')}`
        ...
        // });
        // const data = await response.json();
        console.log('Create jadwal:', formData);
        showNotifikasi({
          type: 'success',
  ...
  const executeDelete = async (id) => {
    try {
      // TODO: Replace with actual API call DELETE /jadwal/{id}
      // const response = await fetch(`https://api.bidan-digital.com/v1/jadwal/${id}`, {
      //   method: 'DELETE',
      //   headers: {
      //     'Authorization': `Bearer ${localStorage.getItem('token')}`
      //   }
